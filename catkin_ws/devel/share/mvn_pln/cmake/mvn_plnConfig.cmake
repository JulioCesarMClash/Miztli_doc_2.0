...
if("TRUE" STREQUAL "TRUE")
  set(mvn_pln_SOURCE_PREFIX /home/joel/Repositories/Miztli_doc_2.0/catkin_ws/src/Navigation/mvn_pln)
  set(mvn_pln_DEVEL_PREFIX /home/joel/Repositories/Miztli_doc_2.0/catkin_ws/devel)
  set(mvn_pln_INSTALL_PREFIX "")
  set(mvn_pln_PREFIX ${mvn_pln_DEVEL_PREFIX})
else()
  set(mvn_pln_SOURCE_PREFIX "")
  set(mvn_pln_DEVEL_PREFIX "")
  set(mvn_pln_INSTALL_PREFIX /home/joel/Repositories/Miztli_doc_2.0/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mvn_pln' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/joel/Repositories/Miztli_doc_2.0/catkin_ws/src/Navigation/mvn_pln/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT mvn_pln_NUM_DUMMY_TARGETS)
      set(mvn_pln_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::mvn_pln::wrapped-linker-option${mvn_pln_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR mvn_pln_NUM_DUMMY_TARGETS "${mvn_pln_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::mvn_pln::wrapped-linker-option${mvn_pln_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND mvn_pln_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(mvn_pln_EXPORTED_TARGETS ${${mvn_pln_dep}_EXPORTED_TARGETS})
endforeach()
